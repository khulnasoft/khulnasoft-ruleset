#!/usr/bin/env python
# Khulnasoft Ruleset Tools: File Test

# v1.0 2016/01/08
# Copyright (C) 2015-2020, Khulnasoft Inc.
# Created by Khulnasoft, Inc. <info@khulnasoft.com>.
# jesus@khulnasoft.com
...
#   git clone https://github.com/khulnasoft/khulnasoft-ruleset.git
#   cd khulnasoft-ruleset/tools/file-testing
...
def usage():
    msg = """
OSSEC Khulnasoft Ruleset Tools: File Test
Github repository: https://github.com/khulnasoft/khulnasoft-ruleset
Full documentation: http://documentation.khulnasoft.com/en/latest/ossec_ruleset.html
