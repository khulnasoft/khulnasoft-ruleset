        ...
        if newFile != "":
            ...
            if options.dumpJson == None:
                ...
                for json_event in j["Records"]:
                    ...
                    # Copy 'aws.sourceIPAddress' and 'aws.userIdentity.userName' to standard fields 'srcip' and 'user' so 'srcip' can be used in Khulnasoft GeoIP lookups and <same_user /> and <same_source_ip /> can be used in composite rules.
